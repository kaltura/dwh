...
CREATE TABLE `kalturadw`.`dwh_dim_partners` (
  ...
  `partner_type_name` VARCHAR(64) DEFAULT 'missing value',
   ...
   `work_group_id` INTEGER ,
	...
	max_monthly_bandwidth_kb BIGINT(20),
	charge_monthly_bandwidth_kb_usd DECIMAL(15,3),
	charge_monthly_bandwidth_kb_unit INT(11),
	max_monthly_storage_mb BIGINT(20),
	charge_monthly_storage_mb_usd DECIMAL(15,3),
	charge_monthly_storage_mb_unit INT(11),
	max_monthly_total_usage_mb BIGINT(20),
	charge_monthly_total_usage_mb_usd DECIMAL(15,3),
	charge_monthly_total_usage_mb_unit INT(11),
