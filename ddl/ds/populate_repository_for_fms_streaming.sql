...
values(2,2,'ds_fms_session_events','kalturadw.dwh_fact_fms_session_events',null,'cycle_id','fms_sessionize', 'event_date_id', 'event_hour_id', '(\'bandwidth_usage\',\'devices\')');
...
VALUES (8, 7, 'ds_fms_session_events', 'kalturadw.dwh_fact_fms_session_events', 'cycle_id', 'fms_sessionize', 'event_date_id', '(\'bandwidth_usage\',\'devices\')','event_hour_id');
