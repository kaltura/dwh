...
SELECT all_time.day_id date_id, partner_id, SUM(count_storage_mb) / DAY(LAST_DAY(date_id)) billable_storage_mb
FROM dwh_hourly_partner_usage u, dwh_dim_time all_time
WHERE all_time.day_id <= DATE(NOW())*1 AND all_time.day_id >= date_id
