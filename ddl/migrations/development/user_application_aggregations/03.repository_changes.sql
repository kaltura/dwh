...
VALUES ('users', 'dwh_hourly_events_context_entry_user_app', 'context_id,user_id,application_id', 'entry_id', 'events', 'dwh_dim_user_reports_allowed_partners', 'partner_id');
