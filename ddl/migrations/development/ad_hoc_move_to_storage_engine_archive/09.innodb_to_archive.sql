...
BEGIN
	...
	CURSOR FOR 
	SELECT partition_name, table_name, CONCAT(table_name,'_archive') archive_name, partition_expression column_name, DATE(partition_description) date_val
	...
	read_loop: LOOP
		...
		WHERE DATE(p.partition_description) = v_date_val
